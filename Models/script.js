...
const MODELS = [
    ...
    {
        name: 'Props and Stuff',
        caption: 'Contains props and stuff models',
        creator: '',
        converter: 'AbayMC',
        category: ['Furniture, Item, tools'],
        thumb: 'https://i.postimg.cc/XY0tfSZh/IMG-20260429-WA0143.jpg',
        link: 'https://www.mediafire.com/file/5gu6n8xw6dg4nce/%255Bprops__and_stuff%255D.zip/file'
    },
    {
        name: 'Gitar Kayu',
        caption: 'Contains Gitar models',
        creator: 'IanAdhi',
        converter: '',
        category: ['Items'],
        thumb: 'https://i.postimg.cc/PfvtKHxm/IMG-20260429-WA0153.jpg',
        link: 'https://www.mediafire.com/file/x05li8vrkj9fsyd/Gitar_Kayu.zip/file'
    },
    {
        name: 'Repper Pack',
        caption: 'Contains Repper Pack models',
        creator: 'IanAdhi',
        converter: '',
        category: ['Items, Cosmetic, Acsesoris'],
        thumb: 'https://i.postimg.cc/gj5pLmLk/IMG-20260430-WA0067.jpg',
        link: 'https://www.mediafire.com/file/z6z2t924bzjm01t/Repper_Pack.zip/file'
    },
    {
        name: 'Kichen Pack',
        caption: 'Contains Kichen Map + models',
        creator: 'Zean',
        converter: '',
        category: ['Map, Furniture'],
        thumb: 'https://i.postimg.cc/MH4wfqfS/IMG-20260430-WA0071.jpg',
        link: 'https://www.mediafire.com/file/rjxc3tij4o74b8f/Kitchen_Pack_Map.zip/file'
    },
    {
        name: 'Camera',
        caption: 'Contains Camera models',
        creator: 'Najwa',
        converter: '',
        category: ['Items'],
        thumb: 'https://i.postimg.cc/pr7v5R5N/IMG-20260430-WA0072.jpg',
        link: 'https://www.mediafire.com/file/7koja1z57qks3ns/Camera_-Najwa-.zip/file'
    },
    {
        name: 'House Furniture',
        caption: 'Contains House Furniture models',
        creator: 'IanAfi',
        converter: '',
        category: ['Furniture'],
        thumb: 'https://i.postimg.cc/C5t0nSnY/IMG-20260430-WA0074.jpg',
        link: 'https://www.mediafire.com/file/268hckv3r5buo4k/House_Furniture_Afi.zip/file'
    },
    {
        name: 'Craft Boad',
        caption: 'Contains Boad models',
        creator: 'IanAdhi',
        converter: '',
        category: ['Vehicle'],
        thumb: 'https://i.postimg.cc/WzwYStqf/IMG-20260429-WA0158.jpg',
        link: 'https://www.mediafire.com/file/lhx2i35x2lttssv/Craft_Boat.zip/file'
    }
